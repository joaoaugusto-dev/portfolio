...
export default function ProjectsAdmin({ token }) {
  ...
  const { dirty, saving: reordering, moveUp, moveDown, save: saveOrder } = useReorder(projects, setProjects, persistOrder);
    ...
    <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
      ...
      <div className="space-y-3">
        ...
        <p className="-mt-1 text-xs text-muted">
          Use as setas para mudar a posição no modo &quot;Relevância&quot; do site. O modo
          &quot;Data&quot; usa a data do projeto.
        </p>
